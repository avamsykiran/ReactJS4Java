...
import { addAccountHolder, selectAccountHolderById, updateAccountHolder } from "../state/AccountHoldersSlice";
...
const AccountHolderForm = () => {
    ...
    const formSubmitted = (ah: AccountHolder) => {
        isEditing ?
            dispatch(updateAccountHolder({changes:ah,id:ah.ahId})):
        ...
        <section className="card card-info m-2 p-2 col-md-5 mx-auto">
            ...
            <form onSubmit={handleSubmit(formSubmitted)}>
                <div className="mb-1">
                    ...
                    <input className="form-control" type="number" {...register('ahId')} readOnly={isEditing} />
